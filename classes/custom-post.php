...
abstract class Custom_Post_Type {
  ...
  protected function post_type_labels() {
    ...
    $arr = array (
      ...
      'insert_into_item'      => sprintf($phrases['insert'], $this->plural),
      'uploaded_to_this_item' => sprintf($phrases['upload'], $this->plural),
      'filter_items_list'     => sprintf($phrases['filter'], $this->label),
      'items_list_navigation' => sprintf($phrases['navig'],  $this->label),
